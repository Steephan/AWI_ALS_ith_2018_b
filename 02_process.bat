...
set COORD=-coord_ref_sys EPSG:32608
set LIM1=-limit "(547800.000,7584000.000,586000.000,7617000.000)"
set LIM2=-limit "(547800.000,7617000.000,586000.000,7660000.000)"
set LIM3=-limit "(547800.000,7660000.000,586000.000,7706000.000)"
...
opalsGrid -inFile 02_intermediate\ALS_last_echotypes_SOR.odm -outFile 04_rasters\ALS_all_echotypes_SOR_terrain_RobF_robMovPlanes_1m_all.tif -interpolation robMovingPlanes -gridSize 1.0 -searchRad 7.5 -filter class[ground] %COORD%
...
opalsStatFilter -inFile 04_rasters\ALS_all_echotypes_SOR_terrain_RobF_robMovPlanes_1m_all.tif -outFile 04_rasters\ALS_all_echotypes_SOR_terrain_RobF_robMovPlanes_1m_smooth_all.tif -feature mean -kernelSize 3 %COORD%
...
opalsAlgebra -inFile 04_rasters\ALS_all_echotypes_SOR_terrain_RobF_robMovPlanes_1m_all.tif 04_rasters\ALS_all_echotypes_SOR_terrain_RobF_robMovPlanes_1m_smooth_all.tif -outFile 04_rasters\ITH_ALS_201808_DTM_all.tif -formula "return r[1] if ( r[0] is None) else r[0]" -gridSize 1.0 %COORD%
...
rem opalsAddInfo -inf 02_intermediate\ALS_last_echotypes_SOR.odm -gridfile 04_rasters\ITH_ALS_201808_DTM_1.tif 04_rasters\ITH_ALS_201808_DTM_2.tif 04_rasters\ITH_ALS_201808_DTM_3.tif -attribute _nZ=Z-r[0]
opalsAddInfo -inf 02_intermediate\ALS_last_echotypes_SOR.odm -gridfile 04_rasters\ITH_ALS_201808_DTM_all.tif -attribute _nZ=Z-r[0]
...
set COORD=-coord_ref_sys EPSG:32608
set LIM1=-limit "(547800.000,7585000.000,586000.000,7617000.000)"
set LIM2=-limit "(547800.000,7617000.000,586000.000,7660000.000)"
set LIM3=-limit "(547800.000,7660000.000,586000.000,7706000.000)"
...
rem opalsCell -inf 02_intermediate\ALS_all_echotypes_SOR_terrain_classified.odm -outf 04_rasters\ALS_all_echotypes_SOR_pcount_gt150_1m.tif -cellsize 1.0 -feature pcount -filter "Generic[_nZ_corr>= 1.5]" %COORD% %LIM1%
rem opalsCell -inf 02_intermediate\ALS_all_echotypes_SOR_terrain_classified.odm -outf 04_rasters\ALS_all_echotypes_SOR_pcount_1m.tif -cellsize 1.0 -feature pcount %COORD% %LIM1%
...
rem opalsAlgebra -inf 04_rasters\ALS_all_echotypes_SOR_pcount_gt150_1m.tif 04_rasters\ALS_all_echotypes_SOR_pcount_1m.tif -outf 04_rasters\ALS_all_echotypes_SOR_vegratio150cm_1m.tif -formula "return float(r[0]) / float(r[1]) if r[1]>0 else None" -gridsize 1.0 %COORD% %LIM1%

rem --- 11 Extraction of individual trees from DSM ---

rem generate DSM and fill
rem opalsCell -inf 02_intermediate\ALS_all_echotypes_SOR_terrain_classified.odm -outf 04_rasters\ALS_all_echotypes_SOR_Z_max_1m.tif -cellsize 1.0 -feature max %COORD% %LIM%
rem opalsStatFilter -inFile 04_rasters\ALS_all_echotypes_SOR_Z_max_1m.tif -outFile 04_rasters\ALS_all_echotypes_SOR_Z_max_1m_smooth.tif -feature mean -kernelSize 3 %COORD% %LIM%
rem opalsAlgebra -inFile 04_rasters\ALS_all_echotypes_SOR_Z_max_1m.tif 04_rasters\ALS_all_echotypes_SOR_Z_max_1m_smooth.tif -outFile 04_rasters\ALS_all_echotypes_SOR_Z_max_1m_filled.tif -formula "return r[1] if ( r[0] is None) else r[0]" -gridSize 1.0 %COORD% %LIM%
...
rem opalsStatFilter -inFile 04_rasters\ALS_all_echotypes_SOR_nZ_max_1m_filled.tif -outFile 04_rasters\ALS_all_echotypes_SOR_nZ_max_1m_ptstats_max_k3.tif -feature max -kernelSize 3 %COORD% %LIM%
...
rem opalsImport -inf 02_intermediate\ALS_all_echotypes_SOR_terrain_classified.txt -outf 02_intermediate\ALS_all_echotypes_SOR_terrain_classified.odm -iformat iformat_all.xml -tilesize 120.0
...
opalsExport -inf 02_intermediate\ALS_all_echotypes_SOR_terrain_classified.odm -outf 04_check\ITH_ALS_2018_1.laz -oformat oformat_pangaea_las.xml -limit 547800 7585000 586000 7617000
opalsExport -inf 02_intermediate\ALS_all_echotypes_SOR_terrain_classified.odm -outf 04_check\ITH_ALS_2018_2.laz -oformat oformat_pangaea_las.xml -limit 547800 7617000 586000 7660000
