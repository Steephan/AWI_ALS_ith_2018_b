...
# fit curve to data on left flank
    ...
    ydata = data_inline[:,1]
    try:
        popt, pcov = curve_fit(funcLeft, xdata, ydata,  p0=(0, -10))
    except:
...
# scatter all data (ew, amp) in plot; add median line
    ...
    ax.text(0.1, 0.65, 'fit: a=%5.3f, b=%5.3f,' % tuple(popt), transform=ax.transAxes)
...
#plt.show()
    figname="05_plots/scatter_terrain_probability_allinone_fixed.png"
